...
import satImage from "../assets/satellite.json";
    ...
    <div className="relative min-h-screen w-full overflow-x-hidden bg-[#000814]">
      ...
      <div className="relative z-10">
        ...
        <section
          className=" b-20 px-6"
          style={{
            paddingTop: window.innerWidth < 1024 ? "80px":"32px"
          }}
        >
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2  items-center">
              ...
              <div className="space-y-8">
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-[Gemini] leading-tight text-white">
                  Unlock the Language of{" "}
                  <span className="text-gradient-isro">Satellite Imagery</span>
                </h1>

                <p className="text-lg font-vendsans text-gray-400 leading-relaxed">
                ...
                <div className="flex flex-wrap gap-4">
                  <button
                    className="group cursor-pointer px-8 py-4 bg-blue-500/20 text-white rounded-lg hover:shadow-2xl hover:shadow-cyan-500/50 transition-all duration-300 hover:scale-105 flex items-center gap-2"
                    onClick={() => {
                      navigate("/geo_nli");
                    }}
                  >
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
                ...
                <h4 className="text-lg text-white mb-2">VLM-Powered</h4>
                <p className="text-sm text-gray-400">
                  Advanced VLMs and Agentic frameworks at a scale
                </p>
              </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8 mb-8">
              <div className="col-span-2">
                <div className="scale-[0.6] origin-top-left mb-4">
                  <OrbitLogo />
                </div>
